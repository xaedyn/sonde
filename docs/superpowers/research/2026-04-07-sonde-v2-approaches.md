...
# Approach Decision Memos — Sonde v2
...
### FIT ASSESSMENT
- **Scale fit:** overengineered — this architecture pays off at sustained high-frequency rendering (games, real-time dashboards with 60fps requirements). Sonde's data arrival rate is ~5-50 points/second, well within main-thread Canvas capacity.
