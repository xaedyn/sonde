...
// matchMedia is not implemented in jsdom; provide a stub so components can
// call window.matchMedia() without throwing.
...
// ResizeObserver is not implemented in jsdom; provide a stub.
